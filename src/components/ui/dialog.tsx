...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    {...props}
     // Prevent dialog close on outside interaction
  />
));
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
      onInteractOutside={(event) => event.preventDefault()} // Prevent dialog close on outside interaction
    >
      {children}
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold text-accent-foreground leading-none tracking-tight",
      className
    )}
    {...props}
  />
